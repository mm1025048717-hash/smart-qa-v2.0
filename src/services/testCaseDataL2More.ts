...
export const L2_ATTRIBUTION_SCENARIOS: Record<string, () => ContentBlock[]> = {
  ...
  // ========== attr-06: 12月份的销售额环比？- 环比KPI+11月vs12月对比图（带归因入口）
  'attr-06': () => [
    B.visualizer([
      { id: 'ds_a06', type: 'datasource', label: '数据源', value: '销售流水', removable: false },
      { id: 'gb_a06', type: 'groupby', label: '按', value: '月度 对比' },
      { id: 'dt_a06', type: 'date', label: '日期', value: '2024年11月 vs 12月' },
    ]),
    B.text('📊 12月份销售额环比分析（带归因入口）：'),
    B.kpi({
      id: 'dec_mom',
      label: '12月销售额',
      value: 3500000,
      prefix: '¥',
      unit: '元',
      trend: { value: 8.6, direction: 'up', label: '较11月增长' },
    }),
    B.text('12月销售额为**350万元**，较11月的**320万元**环比增长**8.6%**（+30万元）。11月受双11透支效应影响下降，12月已恢复增长。'),
    B.barChart({
      data: [
        { month: '11月', value: 320 },
        { month: '12月', value: 350 },
    ...
    B.insight('环比洞察', '12月环比增长8.6%，主要得益于双12促销和年末消费回暖。11月下降主要受双11透支效应影响。'),
    B.actions([
      { id: '1', label: '归因分析', query: '为什么11月销售额下降了？', icon: 'search' },
      { id: '2', label: '月度趋势', query: '今年销售额变化情况', icon: 'trend' },
    ]),
  ],

  // ========== attr-07: 今年销售额是多少？- 年度KPI+月度趋势对比图（带归因入口）
  'attr-07': () => [
    B.visualizer([
      { id: 'ds_a07', type: 'datasource', label: '数据源', value: '销售流水', removable: false },
      { id: 'gb_a07', type: 'groupby', label: '按', value: '月度 分组' },
      { id: 'dt_a07', type: 'date', label: '日期', value: '2024年' },
    ]),
    B.text('📊 2024年销售额年度分析（带归因入口）：'),
    B.kpi({
      id: 'sales_2024_attr',
      label: '2024年度销售额',
      value: 38560000,
    ...
    B.text('2024年销售额达到**3856万元**，同比增长**19.8%**。从月度趋势来看，销售额呈现**稳步上升**态势，10月达到峰值360万元。'),
    B.lineChart({
      data: [
      ...
      currentYear: '2024',
      lastYear: '2023',
      title: '2024年月度趋势对比图（万元）',
    }),
    B.insight('趋势洞察', '11月销售额下降8.6%，主要受双11透支效应影响。12月已恢复增长。'),
    B.actions([
      { id: '1', label: '11月归因', query: '为什么11月销售额下降了？', icon: 'search' },
      { id: '2', label: '增长归因', query: '分析销售额增长原因', icon: 'trend' },
    ]),
  ],

  // ========== attr-08: 本月销售额比上月如何？- 环比分析+周销售趋势（带归因入口）
  'attr-08': () => [
    B.visualizer([
      { id: 'ds_a08', type: 'datasource', label: '数据源', value: '销售流水', removable: false },
      { id: 'gb_a08', type: 'groupby', label: '按', value: '周 分组' },
      { id: 'dt_a08', type: 'date', label: '日期', value: '本月 vs 上月' },
    ]),
    B.text('📈 本月销售额环比分析（带归因入口）：'),
    B.kpi({
      id: 'mom_comparison',
      label: '本月销售额',
      value: 3500000,
      prefix: '¥',
      unit: '元',
      trend: { value: 8.6, direction: 'up', label: '较上月增长' },
    }),
    B.text('本月销售额为**350万元**，较上月的**320万元**环比增长**8.6%**（+30万元）。从周销售趋势来看，本月各周销售额均高于上月同期。'),
    B.lineChart({
      data: [
        { week: '第1周', '本月': 92, '上月': 85 },
        { week: '第2周', '本月': 88, '上月': 78 },
        { week: '第3周', '本月': 85, '上月': 75 },
        { week: '第4周', '本月': 85, '上月': 82 },
      ],
      xKey: 'week',
      type: 'year-comparison',
      currentYear: '本月',
      lastYear: '上月',
      title: '本月 vs 上月周销售趋势对比（万元）',
    }),
    B.insight('环比洞察', '本月各周销售额均高于上月，显示业务持续向好。第1周增长最为明显，环比增长8.2%。'),
    B.actions([
      { id: '1', label: '增长归因', query: '分析销售额增长原因', icon: 'search' },
      { id: '2', label: '月度趋势', query: '今年销售额变化情况', icon: 'trend' },
    ]),
  ],
};
